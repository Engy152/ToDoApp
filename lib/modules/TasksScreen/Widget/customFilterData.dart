...
class CustomShowTaskFilter extends StatelessWidget {
  const CustomShowTaskFilter({
    super.key,
    required this.index,
  });
  final int index;
  ...
  Widget build(BuildContext context,) {
    ...
    return BlocConsumer<TasksCubit,TaskStates>(
      ...
      builder: (BuildContext context, TaskStates state)
      {
        ...
        print(cubit.filteredTasks[index]['date']);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          ...
                          // TasksModel.title?? 'kk',
                          cubit.filteredTasks[index]['title'],
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text(cubit.filteredTasks[index]['startTime'],style: TextStyle(fontSize: 15),),
                            Text(' - '),
                            Text(cubit.filteredTasks[index]['endTime'],style: TextStyle(fontSize: 15),),
                          ],
                        ),
                        SizedBox(height: 10,),
                        Text(cubit.filteredTasks[index]['note'],style: TextStyle(
                          fontSize: 25,
                        ),),
                      ],
                    ),
                    ...
                    Padding(
                      ...
                      child: RotatedBox(
                        quarterTurns: 3,
                        child: Text(
                          cubit.filteredTasks[index]['isCompleted']==true? 'TODO' : 'COMPLETED',
